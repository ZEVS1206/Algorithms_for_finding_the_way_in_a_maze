...
int main(int argc, char *argv[])
{
    ...
    result["start"]         = start;
    result["goal"]          = goal;
    result["jps4"]["path"]          = res_jps4.path;
    result["jps4"]["path_len"]      = res_jps4.path.size();
    result["jps4"]["visited nodes"] = res_jps4.count_of_visited_nodes;
    result["jps4"]["time"]          = res_jps4.total_time;
    result["A*"]["path"]          = res_astar.path;
    result["A*"]["path_len"]      = res_astar.path.size();
    result["A*"]["visited nodes"] = res_astar.count_of_visited_nodes;
    result["A*"]["time"]          = res_astar.total_time;
    result["Dijkstra"]["path"]          = res_dijkstra.path;
    result["Dijkstra"]["path_len"]      = res_dijkstra.path.size();
    result["Dijkstra"]["visited nodes"] = res_dijkstra.count_of_visited_nodes;
    result["Dijkstra"]["time"]          = res_dijkstra.total_time;
